...

{
  ...
  "q5": ["選択したプロパティの番号"],
  "q6": ["選択したプロパティの番号"],
  "aiProposal": "サイトの情報から読み取れる企業の特徴と、おすすめする補助金の活用提案を専門家目線で200〜300文字程度で記載してください。その際、『IT導入補助金』『小規模事業者持続化補助金』『ものづくり補助金』『キャリアアップ助成金』など、活用できそうな【具体的な補助金・助成金の固有名詞】を必ず複数挙げて提案に含めてください。"
}
`;
